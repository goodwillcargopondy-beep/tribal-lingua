...
interface Props {
  show: boolean;
  type: "learned" | "milestone" | "quiz_complete" | "story_complete";
  message?: string;
  onComplete: () => void;
}
...
const MilestoneAnimation = ({ show, type, message, onComplete }: Props) => {
  ...
  useEffect(() => {
    ...
    const t3 = setTimeout(() => { setStep(0); onComplete(); }, 2400);
  ...
  const configs = {
    ...
    milestone: { emoji: "🔓", title: message || "Milestone Unlocked!", color: "#f59e0b", particles: "🔥⚡🌟✨" },
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none">
      ...
      {step >= 1 && particleChars.map((p, i) => (
        <span
          ...
          style={{
            ...
            animation: `milestoneParticle 1.5s ease-out forwards`,
      ...
      <div
        ...
        style={{
          transform: step >= 2 ? "scale(1)" : "scale(0.3)",
          opacity: step >= 2 ? 1 : 0,
        }}
      >
        {type === "milestone" ? (
